...
class abstract_simplicial_complex:
    ...
    #
    #     if is_primal:
    #         c.v = zeros(len(self.complex()[dimension]))
    #     else:
    #         c.v = zeros(len(self.complex()[N - dimension]))
    #
    #     return c
    #
    ...
    #
    #     if is_primal:
    #         c.v = sparse.identity(len(self.complex()[dimension]))
    #     else:
    #         c.v = sparse.identity(len(self.complex()[N - dimension]))
    #
    #     return c
